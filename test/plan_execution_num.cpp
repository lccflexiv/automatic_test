...
void userInputStateMachine(flexiv::Robot* robot)
{
    ...
    try {
        ...
        while (true) {
            ...
            if (robot->isFault()) 
            {
                throw flexiv::ServerException("userInputStateMachine: Fault occurred on robot server, input anything to exit ...");
            }
            ...
            else if (inputBuffer == "l") 
            {
                ...
                std::cout << "===================== Plan name list =====================" << std::endl;
                // Print plan list
            ...
            {
                robot->stop();
                log.info("Execution stopped, you press q");
                return;
            }
...
int main()
{
    ...
    try {
        ...
        std::cout << "[q] - quit the loop" << std::endl;
